...
import 'login.dart';
class odaPage extends StatefulWidget {
  String KateBaslik ;
  odaPage(this.KateBaslik);

  @override
  State<odaPage> createState() => _odaPage();
}

class _odaPage extends State<odaPage> {
  int _currentindex = 0 ;
  List<Map> urun = [
    { "fotograf":"assets/resimler/oda.png","isim":"Belinda Oda","fiyat":"40" },
    { "fotograf":"assets/resimler/oda.png","isim":"Belinda Oda","fiyat":"40" },
    { "fotograf":"assets/resimler/oda.png","isim":"Belinda Oda","fiyat":"40" },
    { "fotograf":"assets/resimler/oda.png","isim":"Belinda Oda","fiyat":"40" },
    { "fotograf":"assets/resimler/oda.png","isim":"Belinda Oda","fiyat":"40" },
