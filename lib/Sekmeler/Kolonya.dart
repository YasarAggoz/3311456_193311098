...
import 'login.dart';
class koloPage extends StatefulWidget {
  String KateBaslik ;
  koloPage(this.KateBaslik);

  @override
  State<koloPage> createState() => _koloPage();
}

class _koloPage extends State<koloPage> {
  int _currentindex = 0 ;
  List<Map> urun = [
    { "fotograf":"assets/resimler/kolonya.png","isim":"Belinda Kolanya","fiyat":"30" },
    { "fotograf":"assets/resimler/kolonya.png","isim":"Belinda Kolanya","fiyat":"30" },
    { "fotograf":"assets/resimler/kolonya.png","isim":"Belinda Kolanya","fiyat":"30" },
    { "fotograf":"assets/resimler/kolonya.png","isim":"Belinda Kolanya","fiyat":"30" },
    { "fotograf":"assets/resimler/kolonya.png","isim":"Belinda Kolanya","fiyat":"30" },
