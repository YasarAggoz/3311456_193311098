...
import 'login.dart';
class exluPage extends StatefulWidget {
  String KateBaslik ;
  exluPage(this.KateBaslik);

  @override
  State<exluPage> createState() => _exluPage();
}

class _exluPage extends State<exluPage> {
  int _currentindex = 0 ;
  List<Map> urun = [
    { "fotograf":"assets/resimler/erkek.png","isim":"Belinda (101) Erkek","fiyat":"180" },
    { "fotograf":"assets/resimler/bayan.png","isim":"Belinda (350) Bayan","fiyat":"180" },
    { "fotograf":"assets/resimler/bayan.png","isim":"Belinda (351) Bayan","fiyat":"180" },
    { "fotograf":"assets/resimler/erkek.png","isim":"Belinda (102) Erkek","fiyat":"180" },
    { "fotograf":"assets/resimler/bayan.png","isim":"Belinde (352) Bayan","fiyat":"180" },
    { "fotograf":"assets/resimler/bayan.png","isim":"Belinde (353) Bayan","fiyat":"90" },
